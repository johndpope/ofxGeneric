...
public:
     ...
     */
    // IOSP-40 // static ofPtr< ofxGenericImage > create( ofPtr< ofImage > image, const std::string& name = "" );
...
protected:
    ...
    // IOSP-40 // virtual void init( ofPtrWeak< ofxGenericImage > setThis, ofPtr< ofImage > image, const std::string& fromFileName );
